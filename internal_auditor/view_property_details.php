<?php
/**
 * View Property Details - Internal Auditor (Read-Only)
...
$query = "
    ...
    WHERE p.property_id = ?
";
$property = $db->fetchRow($query, [$propertyId]);
...
// Get audit logs for this property
$auditQuery = "
    SELECT 
        al.*,
...
<head>
    ...
    <title>Property Details - <?php echo htmlspecialchars($property['owner_name']); ?></title>
    <style>
...
<body>
    <div class="page-header">
        <div style="display: flex; justify-content: space-between; align-items: center;">
            <div>
                <h1 class="page-title">
                    Property of <?php echo htmlspecialchars($property['owner_name']); ?>
                    <span class="read-only-badge">READ-ONLY VIEW</span>
                </h1>
                <p style="color: #718096; margin-top: 5px;">Property #: <?php echo htmlspecialchars($property['property_number']); ?></p>
            </div>
            <a href="view_properties.php" class="btn btn-secondary">Back to List</a>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="info-grid">
            <div class="info-item">
                ...
                <span class="info-value"><?php echo htmlspecialchars($property['property_number']); ?></span>
            </div>
            <div class="info-item">
            ...
            <div class="info-item">
                ...
                <span class="info-value"><?php echo htmlspecialchars($property['telephone'] ?: 'N/A'); ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">Gender</span>
                <span class="info-value"><?php echo htmlspecialchars($property['gender'] ?? 'N/A'); ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">Structure</span>
                <span class="info-value"><?php echo htmlspecialchars($property['structure']); ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">Ownership Type</span>
                <span class="info-value"><?php echo htmlspecialchars($property['ownership_type']); ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">Property Type</span>
                <span class="info-value"><?php echo htmlspecialchars($property['property_type']); ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">Number of Rooms</span>
                <span class="info-value"><?php echo number_format($property['number_of_rooms']); ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">Property Use</span>
                <span class="info-value">
                    <span class="badge badge-<?php echo $property['property_use'] === 'Commercial' ? 'info' : 'success'; ?>">
            ...
            <div class="info-item">
                ...
                <span class="info-value"><?php echo htmlspecialchars($property['zone_name'] ?? 'N/A'); ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">Sub-Zone</span>
                <span class="info-value"><?php echo htmlspecialchars($property['sub_zone_name'] ?? 'N/A'); ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">Created By</span>
                <span class="info-value"><?php echo htmlspecialchars($property['created_by_name'] ?? 'N/A'); ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">Created At</span>
                <span class="info-value"><?php echo date('Y-m-d H:i', strtotime($property['created_at'])); ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">Last Updated</span>
                <span class="info-value"><?php echo date('Y-m-d H:i', strtotime($property['updated_at'])); ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="info-grid">
            <div class="info-item">
                ...
                <span class="info-value">₵ <?php echo number_format($property['old_bill'], 2); ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">Previous Payments</span>
                <span class="info-value">₵ <?php echo number_format($property['previous_payments'], 2); ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">Arrears</span>
                <span class="info-value">₵ <?php echo number_format($property['arrears'], 2); ?></span>
            </div>
            <div class="info-item">
                <span class="info-label">Current Bill</span>
                <span class="info-value">₵ <?php echo number_format($property['current_bill'], 2); ?></span>
            </div>
            <div class="info-item">
    ...
    <div class="card">
        ...
        <div class="info-item" style="margin-bottom: 15px;">
            ...
            <span class="info-value"><?php echo htmlspecialchars($property['location'] ?: 'N/A'); ?></span>
        </div>
        <div class="info-item" style="margin-bottom: 15px;">
            <span class="info-label">Coordinates</span>
            <span class="info-value">
                Lat: <?php echo htmlspecialchars($property['latitude']); ?>, 
                Long: <?php echo htmlspecialchars($property['longitude']); ?>
            </span>
        </div>
        <div class="map-container">
            Map View (Coordinates: <?php echo $property['latitude']; ?>, <?php echo $property['longitude']; ?>)
        </div>
    </div>
    <?php endif; ?>
